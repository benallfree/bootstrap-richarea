...
/***/ function(module, exports, __webpack_require__) {
	...
	window.RichArea = __webpack_require__(3);
	window.RichAreaBaseEditor = __webpack_require__(32);
	...
	RichArea.options = $.extend({
	  mode: 'edit',
	  assetRoot: assetRoot,
	  layouts: [assetRoot + '/templates/layouts.html'],
	  editors: {}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayoutParser = __webpack_require__(4);
	var VueComponentFactory = __webpack_require__(8);
	var Q = __webpack_require__(5);
	var changeCase = changeCase = __webpack_require__(9);
	...
	var RichArea = function () {
	  ...
	  _createClass(RichArea, null, [{
	    ...
	    key: 'ensureLayouts',
	    value: function ensureLayouts(options) {
	      var _this = this;

	      var layoutUrls = options.layouts;
	      var d = Q.defer();
	      var qs = [];
	      layoutUrls.forEach(function (url) {
	        ...
	        qs.push(LayoutParser.parse(url).then(function (layouts) {
	          ...
	          Object.keys(layouts).forEach(function (cid) {
	            ...
	            $.extend(_this.layoutCategories, layouts[cid].categories);
	          });
	          _this.layouts = $.extend(true, {}, layouts, _this.layouts);
	        }));
	      });
	    ...
	    value: function initVue(options) {
	      var items = this.ensureDefaultValues($.extend(true, [], options.items));
	      ...
	      var appData = $.extend(true, options, {
	        content: null,
	        itemsJson: null,
	        currentIdx: null,
	        $currentLayout: null,
	...
	RichArea.registerEditor(__webpack_require__(31));
	RichArea.registerEditor(__webpack_require__(33));
	RichArea.registerEditor(__webpack_require__(34));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.no = exports.noCase = __webpack_require__(10)
	exports.dot = exports.dotCase = __webpack_require__(15)
	exports.swap = exports.swapCase = __webpack_require__(16)
	exports.path = exports.pathCase = __webpack_require__(18)
	exports.upper = exports.upperCase = __webpack_require__(17)
	exports.lower = exports.lowerCase = __webpack_require__(11)
	exports.camel = exports.camelCase = __webpack_require__(19)
	exports.snake = exports.snakeCase = __webpack_require__(20)
	exports.title = exports.titleCase = __webpack_require__(21)
	exports.param = exports.paramCase = __webpack_require__(22)
	exports.header = exports.headerCase = __webpack_require__(23)
	exports.pascal = exports.pascalCase = __webpack_require__(24)
	...
	exports.ucFirst = exports.upperCaseFirst = __webpack_require__(25)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(11)

	var NON_WORD_REGEXP = __webpack_require__(12)
	var CAMEL_CASE_REGEXP = __webpack_require__(13)
	var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(14)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noCase = __webpack_require__(10)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var upperCaseFirst = __webpack_require__(25)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var upperCase = __webpack_require__(17)
	var snakeCase = __webpack_require__(20)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseEditor = __webpack_require__(32);
