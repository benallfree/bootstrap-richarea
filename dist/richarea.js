...
/***/ function(module, exports, __webpack_require__) {
	...
	var RichArea = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RichArea = function () {
	  ...
	  _createClass(RichArea, null, [{
	    ...
	    key: 'ensureLayouts',
	    value: function ensureLayouts(layoutUrls) {
	      var _this = this;
	        ...
	        qs.push(LayoutParser.parse(url).then(function (layouts) {
	          ...
	          for (var layout_id in layouts) {
	            ...
	            for (var field_key in layout.fields) {
	              ...
	              _this.editors[field.editor].initField(field, layout);
	            }
	          }
	          ...
	          Object.keys(layouts).forEach(function (cid) {
	            ...
	            $.extend(_this.layoutCategorieslayouts, layouts[cid].categories);
	          });
	...
	RichArea.registerEditor(__webpack_require__(9));
	RichArea.registerEditor(__webpack_require__(11));
	RichArea.registerEditor(__webpack_require__(12));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseEditor = __webpack_require__(10);
...
/***/ function(module, exports) {
	...
	var BaseEditor = function () {
	  ...
	  _createClass(BaseEditor, null, [{
	    key: "initField",
	    value: function initField(field, layout) {}
	  }, {
	    key: "getVueData",
	    value: function getVueData() {
